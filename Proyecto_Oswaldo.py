...
# Grafica de valianza acumulada de 1 hasta 70 componentes.
explained_variance = []
for n_components in range(1, 71):
...
fig = px.line(
    ...
    markers=True  # muestra puntitos en cada valor
)
# definir color de línea y de marcadores
fig.update_traces(
    line=dict(color="#295bff", width=2),
    marker=dict(color="#295bff", size=5, symbol="circle")
)
...
fig.show()
fig.write_image("Varianza_Acumulada.png", scale=4)
